{
  ...
  burpHash = "sha256-iI8FiM+Co7cNUI3L8HWRGEomJJ44zajqi1po9LWjB4k=";
...
in
  buildFHSEnv {
    ...
    extraInstallCommands = ''
      ...
      ${lib.getBin unzip}/bin/unzip -p ${burpSrc} resources/Media/icon64pro.png > $out/share/pixmaps/burpsuitepro.png
